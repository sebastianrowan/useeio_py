...
def compare_E_and_LCI_result(model, use_domestic = False, tolerance = 0.05):
    '''
...
def calculate_product_of_leontif_and_production_demand(model, use_domestic):
    '''
...
def compare_output_and_leontif_x_demand(model, use_domestic = False, tolerance = 0.05):
    '''
...
def compare_commodity_output_and_domestic_use_plus_production_demand(model, tolerance = 0.05):
    '''
...
def compare_commodity_output_x_market_share_and_industry_output_with_cpi_transformation(model, tolerance = 0.05):
    '''
...
def generate_chi_matrix(model, output_type = "Commodity"):
    '''
...
def compare_industry_output_in_make_and_use(model, tolerance):
    '''
...
def validate_result(result, tolerance, abs_diff = True):
    '''
...
def extract_validation_result(validation, failure = True):
    '''
...
def format_validation_result(result, tolerance, abs_diff = True):
    '''
...
def check_names_and_ordering(n1, n2, note):
    '''
...
def remove_hybrid_processes(model, object):
    '''
